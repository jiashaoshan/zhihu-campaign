...
└────────┬─────────┘  └───────────┬──────────────┘
         ...
         │  http://127.0.0.1 │    - dd8a7911-69b4-409f-aa14-42a7a5aeddc2 (搜索)
         │       :8080       │    - f3ac1d6a-0489-467f-a0eb-c275faecd839 (评论)
         └──────────────────┘    - 8478f76d-5a6b-4fee-9155-4dbedb3a5aa4 (发布文章)
```
...
└──────────┘   └──────────┘   └──────────┘   └──────────┘   └──────────┘
     │              │               │              │
 模板驱动       本地存储       下载到本地      BW脚本8478f76d-5a6b-4fee-9155-4dbedb3a5aa4
...
└──────────┘   └──────────┘   └──────────┘   └──────────┘   └──────────┘
  ...
  + 种子池      dd8a7911-69b4-409f-aa14-42a7a5aeddc2                        随机选择      每日15条上限
  备选降级                                        每小时5条上限
```
